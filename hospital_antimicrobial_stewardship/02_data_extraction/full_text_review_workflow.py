...
def main():
    ...
    # Save review plan
    plan_file = f"hospital_antimicrobial_stewardship/02_data_extraction/full_text_review_plan_{timestamp}.json"
    with open(plan_file, 'w') as f:
        json.dump(review_package['review_plan'], f, indent=2)
    print(f"\nReview plan saved to: {plan_file}")

    # Save study packages
    study_packages_file = f"hospital_antimicrobial_stewardship/02_data_extraction/study_packages_{timestamp}.json"
    ...
    workbook_file = f"hospital_antimicrobial_stewardship/02_data_extraction/data_extraction_workbook_template_{timestamp}.json"
    ...
    qc_file = f"hospital_antimicrobial_stewardship/02_data_extraction/quality_control_guidelines_{timestamp}.json"
    ...
    workflow_guide_file = f"hospital_antimicrobial_stewardship/02_data_extraction/full_text_review_workflow_guide_{timestamp}.txt"
    ...
    with open(workflow_guide_file, 'w') as f:
        ...
        f.write(f"Estimated completion time: {plan['estimated_review_time']['total_hours"]} hours\n")
        f.write(f"Recommended timeline: {plan['estimated_completion_weeks']} weeks\n\n")
